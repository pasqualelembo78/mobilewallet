...
protected List<ReactPackage> getPackages() {
    // Crea la lista dei package autolinkati
    List<ReactPackage> packages = new PackageList(this).getPackages();

    // Aggiungi manualmente i package che non si auto-linkano
    packages.add(new RNBackgroundFetchPackage());
    packages.add(new TurtleCoinPackage());
    packages.add(new BalancePackage());  // <-- qui va inserito dopo che 'packages' esiste
